...
public class PermissionService {
     ...
     * 没有权限，hidden用于前端隐藏按钮
     */
    public static final String NO_ACCESS = "hidden";
    ...
    public String hasPermi(String permission) {
        return isPermitted(permission) ? StringUtil.EMPTY : NO_ACCESS;
    }
    ...
    public String lacksPermi(String permission) {
        return isLacksPermitted(permission) ? StringUtil.EMPTY : NO_ACCESS;
    }
    ...
    public String hasAnyPermi(String permissions) {
        return hasAnyPermissions(permissions, PERMISSION_SEPARATOR) ? StringUtil.EMPTY : NO_ACCESS;
    }
    ...
    public String hasRole(String role) {
        return isRole(role) ? StringUtil.EMPTY : NO_ACCESS;
    }
    ...
    public String lacksRole(String role) {
        return isLacksRole(role) ? StringUtil.EMPTY : NO_ACCESS;
    }
    ...
    public String hasAnyRoles(String roles) {
        return isAnyRoles(roles, ROLE_SEPARATOR) ? StringUtil.EMPTY : NO_ACCESS;
    }
    ...
    public boolean hasAnyPermissions(String permissions) {
        return hasAnyPermissions(permissions, PERMISSION_SEPARATOR);
    }
    ...
    public boolean hasAnyPermissions(String permissions, String delimeter) {
        ...
        if (subject != null) {
            if (delimeter == null || delimeter.length() == 0) {
                delimeter = PERMISSION_SEPARATOR;
            }
    ...
    public boolean isAnyRoles(String roles) {
        return isAnyRoles(roles, ROLE_SEPARATOR);
    }
